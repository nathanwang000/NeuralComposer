...
import { Mic, Upload, Play, Square, Download, ArrowLeft } from 'lucide-react';
            ...
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                    ...
                    <textarea
                        value={midiOutput}
                        readOnly
                        className="w-full h-32 bg-gray-900 border border-gray-700 rounded p-4 font-mono text-sm text-green-400 focus:outline-none focus:border-cyan-500"
